...
<header>
  <div id="logo"><a href="selectAllBlog2"></a></div>
   <nav class="topnav" id="topnav">
            <a href="selectAllBlog"><span>Exit</span><span class="en">退出管理</span></a>
    ...
    <div class="banner"></div><br>
        ...
        <div class="bloglist">
            ...
            <c:forEach items="${blogs}" var="blogs">
                <h3>
                <a href="selectBlogById?blogid=<c:out value="${blogs.blogid}"/>" class="readmore"><c:out value="${blogs.blogtitle}"/></a>
                </h3>
